    ...
    sceneEl.addEventListener("enter-vr", function() {
      if (this.is("ar-mode")) {
        ...
        this.addEventListener(
          ...
          function() {
            message.innerHTML = `Select the location to place The Logo<br />By tapping on the screen or selecting with your controller.`;
          },
          { once: true }
        );
        ...
        this.addEventListener(
          ...
          function() {
            ...
            message.textContent = "Well done! Demo By Metaverse Laboratory.";
          },
          { once: true }
        );
      }
